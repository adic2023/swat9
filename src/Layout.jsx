  ...
  return (
    <div className={`app ${dark ? 'theme-dark' : 'theme-light'}`}>
      ...
      <header className="site-header">
        <NavLink to="/" className="site-name" style={{ textDecoration: 'none' }}>
          The Swat IX<span className="site-name-archive">[ARCHIVE]</span>
        </NavLink>
      ...
      <footer className="site-footer">
        ...
        <NavLink className="footer-privacy" to="/privacy">Privacy Policy</NavLink>
        <MailingListForm />
      </footer>
