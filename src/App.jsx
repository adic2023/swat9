  ...
  return (
    <Layout showPopup dark={dark} setDark={setDark}>
      ...
      <div className="prose">
        ...
        <p>We stand in solidarity with the nine protestors and affirm the call progressed by Swarthmore students and faculty, including Swarthmore SJP, for an academic boycott of Swarthmore College.</p>
